namespace CepheusState
{
    ...
    public class Projectile3 : BaseState
    {
        ...
        public Projectile3(GameObject boss) : base(boss)
        {
        ...
        public override State StateUpdate()
        {
            ...
            if (Time.time - startTime >= duration)
            {
                ...
                boss.transform.position = Vector3.MoveTowards(boss.transform.position, cepheusController.point4.position, _moveSpeed);

                if (boss.transform.position == cepheusController.point4.position)
                    return new FollowPlayer(boss);
            }
