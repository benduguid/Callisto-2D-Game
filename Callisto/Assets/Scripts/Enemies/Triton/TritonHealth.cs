...
public class TritonHealth : MonoBehaviour
{
    private float STARTING_HEALTH = 50;
    public float CurrentHealth;

    [SerializeField] private Slider bossHealthBar;
    [SerializeField] private TritonController tritonController;
